...
import static civvi.stomp.Headers.MESSAGE_ID;
...
public class Frame {
	 ...
	 * @return
	 */
	public static Builder message(String destination) {
		return builder(Command.MESSAGE).destination(destination);
	}
	 ...
	 * @return
	 */
	public static Builder message(String destination, String messageId) {
		return builder(Command.MESSAGE).destination(destination).messageId(messageId);
	}

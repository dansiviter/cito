...
import static flngr.DestinationEvent.DestinationType.QUEUE;
import static flngr.DestinationEvent.DestinationType.TOPIC;
import static flngr.stomp.server.annotation.Qualifiers.onDestinaton;
...
import flngr.DestinationEvent.DestinationType;
import flngr.DestinationEvent.Type;
...
public class EventProducer implements NotificationListener {
	...
	@Inject
	private Event<flngr.DestinationEvent> destinationEvent;
	...
	public void onNotification(Notification notif) {
		...
		this.destinationEvent.select(onDestinaton(type)).fire(new flngr.DestinationEvent(type, destinationType, destination));
	}

...
import flngr.stomp.server.AbstractSession;
...
public class EventSourceSession extends AbstractSession {
	...
	public EventSourceSession(HttpServletRequest request, Map<String, Object> userProperties, AsyncContext asyncCtx) {
		super(request, userProperties);
